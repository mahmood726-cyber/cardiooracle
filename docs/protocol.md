        # Cardiooracle: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/cardiooracle.git

        ## Objective

        CardioOracle is a cardiovascular trial outcome predictor that uses calibrated Bayesian meta-regression to forecast treatment effects in novel patient populations.
        ...
        - Code: https://github.com/mahmood726-cyber/cardiooracle.git
        - Dashboard: https://mahmood726-cyber.github.io/cardiooracle/
